...
% (freely optimizable waveforms) with Chebyshev basis.
...
savePathTop = fullfile( tld, 'data', 'opt', ...
    '2025-02-02-cheb-base-test', strcat( 'opt', timestr ));
...
% pulse.runningCostFunction = "arccos-least-squares";
% pulse.runningCostWeightingCoefficient = 1e-2;
% pulse.runningCostFunction = "RF-power-cheb";
% pulse.runningCostWeightingCoefficient = 1e-4;
...
pulse.orderCheb_RF = 15;
pulse.orderCheb_grad = 10;
