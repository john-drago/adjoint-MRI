...
savePathTop = fullfile( tld, 'data', 'opt', ...
    '2025-02-05-SPINS-base-test', strcat( 'opt', timestr ));
...
constraints = {...
    ...
    "average-local-SAR", 15;... % W/kg
    "average-global-SAR", 8;... % W/kg
    "grad-max", 15e-3;... % T/m
...
pulse.min_u = ( 2*pi * 1000 ); % rad/m
pulse.max_u = ( 2*pi * 10 * 1000 ); % rad/m
pulse.min_v = ( 2*pi * 1000 ); % rad/m
...
oc.gaopt.InitialPopulationRange = 0.0025 * [ -1; 1 ];
