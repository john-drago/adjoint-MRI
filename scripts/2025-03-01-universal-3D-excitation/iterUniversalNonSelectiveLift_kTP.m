...
note = "Iterative universal nonselective lift pulse design - kTP initialization";
...
numIterOptInitialIP = 250;
numIterOptMiddleIP = 150;
numIterOptFinalIP = 250;

numIterOptInitialSQP = 500;
numIterOptMiddleSQP = 300;
numIterOptFinalSQP = 500;
relLineSrchBndInitial = 5e-2;
...
% pwccoeffs = getPWCOptCoeffs( wvkTP, optInit.tvec );
% 
