function [ c, gradc ] = constraintPPTotalRFPower( pSc, opt )
...
if nargout > 1
    ...
    grad_breal = 2 * transpose( varsToTimepoints_RF ) * ( varsToTimepoints_RF * breal_shape_rshp );
    ...
    grad_bimag = 2 * transpose( varsToTimepoints_RF ) * ( varsToTimepoints_RF * bimag_shape_rshp );
