...
settings.note = note;
settings.savePathTopString = fullfile( settings.tld, 'data', 'opt', ...
    '2025-03-02-universal-2D-excitation-settings-explore-init-pwc-10-active-set', strcat( 'spokeSettings', '__', char(datetime('now', 'format','yyMMddHHmmss') ) ) );
