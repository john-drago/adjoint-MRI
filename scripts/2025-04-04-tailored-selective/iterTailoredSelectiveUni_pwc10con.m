...
note = [...
    ...
    "Piecewise constant 10 degree flip angle WITH bandwidth constraint" ];
...
savePathTop = fullfile( tld, 'data', 'opt',...
    ...
    '2025-04-04-tailored-spokes-init-10-pwc-con',...
    strcat( 'opt', timestr ) );

% active-set
prevOptDirPath = fullfile( tld, "data", "opt",...
    "2025-04-03-universal-selective",...
    "2025-04-03-universal-spokes-init-10-pwc-con",...
    "XXXXXXXX" );
