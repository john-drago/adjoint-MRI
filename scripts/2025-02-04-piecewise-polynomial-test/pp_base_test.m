...
% (freely optimizable waveforms) with piecewise-continuous polynomial basis
% (implemented with Chebyshev polynomials).
...
savePathTop = fullfile( tld, 'data', 'opt', ...
    '2025-02-04-pp-base-test', strcat( 'opt', timestr ));
...
pulse.timing_RF = [ 0, 1, 2, 3 ] * 1e-3;
pulse.timing_grad = [ 0, 0.5, 1, 1.5, 2, 2.5, 3 ] * 1e-3;
pulse.timing_shim = [ 0, 1.5, 3 ] * 1e-3;

pulse.orderPP_RF = 8;
pulse.orderPP_grad = 4;
pulse.orderPP_shim = 3;
