...
note = "Iterative tailored selective pulse design from universal";
...
savePathTop = fullfile( tld, 'data', 'opt',...
    '2025-03-04-tailored-selective',...
    '2025-03-04-tailored-spokes-init-10-cheb',...
    strcat( 'opt', timestr ) );
