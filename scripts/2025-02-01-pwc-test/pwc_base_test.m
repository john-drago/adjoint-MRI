...
% (freely optimizable waveforms) with piecewise-constant
% basis.
...
savePathTop = fullfile( tld, 'data', 'opt', ...
    '2025-02-01-pwc-base-test', strcat( 'opt', timestr ));
...
constraints = {...
    ...
    "average-local-SAR", 1e3;... % W/kg
    "average-global-SAR", 1e3;... % W/kg
    "grad-max", 15e-3;... % T/m
...
% pulse.runningCostFunction = "RF-power-pwc";
...
% PWC specific parameters
pulse.name = "pwc";
pulse.type = "base";

pulse.length = 0.5e-3; % time in seconds
