...
savePathTop = fullfile( tld, 'data', 'opt',...
    ...
    '2025-04-01-universal-kTP-init-90-cheb',...
    strcat( 'opt', timestr ) );
...
for ss = 1:length( solverNames )
    ...
    if st.initialGuessOnly
        ...
        elseif matches( solverName, 'ipopt' )
            ...
            oc.ipopt.options.ipopt.tol = 1e-4;
            oc.ipopt.options.ipopt = rmfield( oc.ipopt.options.ipopt, 'tol' );
            oc.ipopt.options.ipopt = rmfield( oc.ipopt.options.ipopt, 'constr_viol_tol' );
            oc.ipopt.options.ipopt = rmfield( oc.ipopt.options.ipopt, 'dual_inf_tol' );
            oc.ipopt.options.ipopt = rmfield( oc.ipopt.options.ipopt, 'compl_inf_tol' );
            oc.ipopt.options.ipopt = rmfield( oc.ipopt.options.ipopt, 'alpha_min_frac' );
            oc.ipopt.options.ipopt = rmfield( oc.ipopt.options.ipopt, 'max_soc' );
            oc.ipopt.options.ipopt = rmfield( oc.ipopt.options.ipopt, 'recalc_y_feas_tol' );
