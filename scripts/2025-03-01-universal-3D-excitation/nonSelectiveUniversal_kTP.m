...
savePathTop = fullfile( mpd, 'data', 'opt', ...
    '2025-03-01-universal-3D-excitation-kTP-init-XXXName-XXXSolver', strcat( 'opt', timestr ) );
...
% oc.fminopt.RelLineSrchBnd = 1e-2;
...
oc.ipopt.options.ipopt.tol = 1e-5; % desired convergence tolerance
oc.ipopt.options.ipopt.constr_viol_tol = 1e-8;
...
oc.ipopt.options.ipopt.mu_init = 1e-5;
oc.ipopt.options.ipopt.mu_linear_decrease_factor = 0.2;
oc.ipopt.options.ipopt.mu_superlinear_decrease_power = 1.05;
oc.ipopt.options.ipopt.barrier_tol_factor = 5;
oc.ipopt.options.ipopt.alpha_red_factor = 0.50;
oc.ipopt.options.ipopt.limited_memory_max_history = 50;
oc.ipopt.options.ipopt.nlp_scaling_max_gradient = 1.0;
