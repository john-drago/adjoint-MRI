function [ h, gradxT_h, gradp_h ] = runFAWithMeanPhaseEntireSliceCost( Mfinal, ~, opt )
...
for ss = 1:opt.numSubj
    ...
    % Mxymag_inslice = sqrt( Mx_inslice.^2 + My_inslice.^2 );
    ...
    Mxavg_inslice = mean( Mx_inslice );
    Myavg_inslice = mean( My_inslice );

    Mxytargph_inslice = atan2( Myavg_inslice, Mxavg_inslice );
    targFAphase_inslice = exp( 1j * Mxytargph_inslice );

    thetatarg_inslice = targFA_inslice .* targFAphase_inslice;
    ...
    if nargout > 1
        ...
        derr_dthetatargph_inslice = -1j * thetatarg_inslice;
        ...
        Mxyavgsq_inslice = ( Mxavg_inslice.^2 + Myavg_inslice.^2 );

        dthetatargph_dMx_inslice = ( -1 / numInSlice ) * ( Myavg_inslice ./ Mxyavgsq_inslice );
        dthetatargph_dMy_inslice = (  1 / numInSlice ) * ( Mxavg_inslice ./ Mxyavgsq_inslice );
        ...
        dcost_dthetatargph_inslice = real( dcost_derr_inslice .*  derr_dthetatargph_inslice );

        dcost_dMx_inslice = dcost_dthetaph_inslice .* dthetaph_dMx_inslice +...
            sum( dcost_dthetatargph_inslice .* dthetatargph_dMx_inslice );
        dcost_dMy_inslice = dcost_dthetaph_inslice .* dthetaph_dMy_inslice +...
            sum( dcost_dthetatargph_inslice .* dthetatargph_dMy_inslice );
