function [ oc, pulse, opt ] = processMPpTxPulse_orblipmpconst( oc, pulse, opt )
...
opt.generatePlotWaveforms = @generateMPpTxPlotWaveform_orblipmpconst;
opt.generateWaveforms = @generateMPpTxWaveform_orblipmpconst;

%% Add function to calculate gradp_f array
opt.forwardModelGradientFunction = @forwardModelGradientMPpTx_orblipmpconst;

if opt.useGPU
    opt.gpuArrayAdjointFunction = @gpuArrayAdjointMPpTx_orblipmpconst;
