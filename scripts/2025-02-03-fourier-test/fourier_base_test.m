...
% (freely optimizable waveforms) with Fourier basis (for
% both RF waveforms and gradient waveforms).
...
savePathTop = fullfile( tld, 'data', 'opt', ...
    '2025-02-03-fourier-base-test', strcat( 'opt', timestr ));
...
pulse.orderFourier_grad = 7;
pulse.orderFourier_shim = 6;
pulse.length = 1e-3;
