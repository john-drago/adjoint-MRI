...
savePathTop = fullfile( tld, 'data', 'opt', ...
    '2025-03-02-universal-2D-excitation-spokes-init-XXXName-XXXSolver', strcat( 'opt', timestr ) );
...
% pulse.name = "fourier";
% pulse.type = "base";
% % pulse.orderFourier_RF = 35;
% % pulse.orderFourier_grad = 50;
...
% % oc.fminopt.TypicalX = '0.5*ones(numOfVariables,1)';
