...
note = [...
    "Iterative tailored nonselective pulse design - from universal pulse with kTP initialization";...
    "kTP 180 degree flip angle" ];
...
savePathTop = fullfile( tld, 'data', 'opt', ...
    ...
    '2025-04-02-tailored-kTP-init-180-kTP',...
    strcat( 'opt', timestr ) );

prevOptDirPath = fullfile( tld, "data", "opt", ...
    '2025-04-01-universal-nonselective',...
    "2025-04-01-universal-kTP-init-180-kTP",...
    "XXXXXXXX" );
