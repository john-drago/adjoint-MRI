function [ c, gradc ] = constraintChebAvgGlobalSAR( pSc, opt )
...
if nargout > 1
    ...
    gradc_unsc( breal_idx_rshp ) = ( transpose( TnT ) * real( gradf_zbar_rshp ) ) .* breal_sc_rshp;
    gradc_unsc( bimag_idx_rshp ) = ( transpose( TnT ) * imag( gradf_zbar_rshp ) ) .* bimag_sc_rshp;
