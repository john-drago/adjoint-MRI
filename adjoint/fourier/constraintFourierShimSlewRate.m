function [ c, shimc ] = constraintFourierShimSlewRate( pSc, opt )
...
c_unsc = transpose( shim_max ) - shimSlewRateConstr;
...
if nargout > 1
    ...
    shimc = shimc_unsc / shimSlewRateConstr;
