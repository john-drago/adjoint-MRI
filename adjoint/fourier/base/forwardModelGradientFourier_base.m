function [ partialfpartialp, varInfo, initSt ] = ...
    forwardModelGradientFourier_base( partialfpartialp, initSt, wv, opt, nn )
...
partialfpartialp = placepartialfpartialpCalculation(...
    partialfpartialp,...
    calcpartialBpartialGradFourier( initSt.partialfpartialBz, opt, wv, nn ),...
    varInfo );
...
if opt.numZCoils > 0
    ...
    partialfpartialp = placepartialfpartialpCalculation(...
        partialfpartialp,...
        calcpartialBpartialShimFourier( initSt.partialfpartialBz, opt, wv, nn ),...
        varInfo );
end
