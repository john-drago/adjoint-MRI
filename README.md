...
![adjoint-description](./readme/adjoint-description.png)
...
mexIPOPT can also be compiled with IPOPT on Mac ARM (Apple Silicon), following [this discussion](https://github.com/ebertolazzi/mexIPOPT/issues/24), ([archived link](https://web.archive.org/web/20240921210604/https://github.com/ebertolazzi/mexIPOPT/issues/24)).
...
Place the provided `homebrew_ipopt.patch` file (included in this repo under the `readme` diretory) into `$WORKPATH/mexIPOPT/toolbox`. Then run shell commands:
