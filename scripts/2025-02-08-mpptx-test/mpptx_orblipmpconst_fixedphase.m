...
savePathTop = fullfile( tld, 'data', 'opt', ...
    '2025-02-08-mpptx-orblipmpconst-fixedphase-test', strcat( 'opt', timestr ));
...
pulse.name = "mpptx";
pulse.type = "or-blip-mp-const-fixed-phase";
...
pulse.minSlewTime = 10e-6; % seconds, specific parameter for MP-pTx pulses
pulse.minRFSlewTime = 5e-6; % seconds, specific parameter for MP-pTx const pulses
