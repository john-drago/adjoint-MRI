...
note = "Universal nonselective pulse design - SPINS initialization";
...
%% File control
savePathTop = fullfile( mpd, 'data', 'opt', ...
    '2025-03-01-universal-3D-excitation-SPINS-init-XXXName-XXXSolver', strcat( 'opt', timestr ) );
...
% oc.optType = "nlopt";
% oc.nlopt = struct;
% oc.nlopt.ConstraintTolerance = 1e-8;
% oc.nlopt.stopval = eps;
% oc.nlopt.ftol_rel = 1e-6;
% oc.nlopt.ftol_abs = 1e-6;
% oc.nlopt.xtol_rel = 1e-6;
% oc.nlopt.verbose = 1;
% % oc.nlopt.algorithm = NLOPT_LD_SLSQP;
% oc.nlopt.algorithm = NLOPT_LD_MMA;
% 
% oc.nlopt.maxtime = maxOptTime;
% oc.nlopt.maxeval = maxOptIterations * 2.5;
...
% oc.ipopt.options.ipopt.mu_min = 1e-10;
% oc.ipopt.options.ipopt.mu_max = 1e-4;
...
[ RF0t_init, G0t_init, K0t_init, s0init, staStinit, outputinit ] = optimizeSPINSSTA(...
    ...
    opt, pulse, fminMaxIterations, fminMaxIterations );
