function [ partialfpartialp, varInfo, initSt ] = ...
    forwardModelGradientMPpTx_orblipmpconst_fixedphase( partialfpartialp, initSt, wv, opt, tt )
...
if opt.numZCoils > 0
    ...
    if ( tt >= opt.Blip_i ) && ( tt < opt.Blip_Shim_Slew_i )
        ...
        varInfo = addVarIdxs( opt.shimmag_MPSP_idx, varInfo );

        partialfpartialp = placepartialfpartialpCalculation(...
            partialfpartialp,...
            calcpartialfpartialshim( ( ( wv.shim_Blip_scale * (ti - wv.tStBlip ) )/wv.BlipShimSlewTime ) * wv.bzsens, initSt.partialfpartialBz, opt ),...
            varInfo );

        varInfo = addVarIdxs( opt.shimblipscale_idx, varInfo );

        partialfpartialp = placepartialfpartialpCalculation(...
            partialfpartialp,...
            calcpartialfpartialshimscalar( wv.bzsens * ( ( (ti - wv.tStBlip )/wv.BlipShimSlewTime ) * wv.shim_mag_MPSP ), initSt.partialfpartialBz ),...
            varInfo );
    ...
    if ( tt >= opt.Blip_Shim_Slew_i ) && ( tt <= opt.Blip_Shim_Slew_f )
        ...
        partialfpartialp = placepartialfpartialpCalculation(...
            partialfpartialp,...
            calcpartialfpartialshim( wv.shim_Blip_scale * wv.bzsens, initSt.partialfpartialBz, opt ),...
            varInfo );
        ...
        partialfpartialp = placepartialfpartialpCalculation(...
            partialfpartialp,...
            calcpartialfpartialshimscalar( wv.bzsens * wv.shim_mag_MPSP, initSt.partialfpartialBz ),...
            varInfo );
    ...
    if ( tt <= opt.Blip_f ) && ( tt > opt.Blip_Shim_Slew_f )
        ...
        partialfpartialp = placepartialfpartialpCalculation(...
            partialfpartialp,...
            calcpartialfpartialshim( ( (- wv.shim_Blip_scale * (ti - wv.tEndBlip ) )/wv.BlipShimSlewTime ) * wv.bzsens, initSt.partialfpartialBz, opt ),...
            varInfo );
        ...
        partialfpartialp = placepartialfpartialpCalculation(...
            partialfpartialp,...
            calcpartialfpartialshimscalar( wv.bzsens * ( ( -(ti - wv.tEndBlip )/wv.BlipShimSlewTime ) * wv.shim_mag_MPSP ), initSt.partialfpartialBz ),...
            varInfo );
    end
...
if opt.numZCoils > 0
    ...
    if ( tt >= opt.MPSP_i ) && ( tt < opt.MPSP_Shim_Slew_i )
        ...
        partialfpartialp = placepartialfpartialpCalculation(...
            ...
            wv.bzsens .* ( partBpartamag ),...
            initSt.partialfpartialBz, opt ),...
            varInfo );

        varInfo = addVarIdxs( opt.shimph_MPSP_idx, varInfo );

        partialfpartialp = placepartialfpartialpCalculation(...
            partialfpartialp,...
            calcpartialfpartialshimscalar(...
            wv.bzsens * ( partBpartaph ),...
            initSt.partialfpartialBz ),...
            varInfo );
    end
